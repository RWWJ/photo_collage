...
let jsonFromLocalStorage = fromLocalStorage;  // Legacy support


//
// Write value contents to localStorage (browser "internal" storage) in json format
//
// Previously called jsonToLocalStorage() with params reversed (backwards, logically and compared to localStorage.setItem())
//
...
function jsonToLocalStorage( variable, variableName ) {
  toLocalStorage( variableName, variable );
}
